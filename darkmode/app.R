...
library(shiny)
library(shinythemes)
source("~/Documents/projects/covid19/darkmode/appHelpers.R")
  ...
  ui <- fluidPage(theme = shinytheme("darkly"),
    navbarPage("COVID-19 Data Visualization", 
      ...
      tabPanel(
          ...
          data-theme='dark' data-vanity='johnfmaner'><a class='LI-simple-link' 
      ...
      Additionally: OWID data includes corrections from official sources, which may appear as negative values when viewing new cases, new tests, new deaths, etc. Currently, 
